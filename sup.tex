...
Assumption 3 negates this complication since eliminates the need to consider
exactly when each relaxation happens, only total number of relaxations before
the PKA reaches $d$.
